    ...
    async getAllOrders() {
        const query = `
            SELECT
                ...
                o.production_due_at,
                o.promised_ship_at,
                (SELECT jsonb_agg(item - 'content') FROM jsonb_array_elements(o.items) AS item) AS items,
                o.selections,
                o.shipping_info,
                o.address,
                o.phone,
